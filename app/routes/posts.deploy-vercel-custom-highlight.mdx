---
meta:
  - title: 部署到vercel和自定义代码高亮
  - name: description
    content: 接《用MDX和Remix创建自己的Blog》，本文将介绍如何将博客部署到vercel和自定义代码高亮。
  - name: twitter:card
    content: summary_large_image
  - name: twitter:title
    content: 部署到vercel和自定义代码高亮
  ...
  - property: og:description
    content: 接《用MDX和Remix创建自己的Blog》，本文将介绍如何将博客部署到vercel和自定义代码高亮。
  - name: twitter:image
    content: https://i.imgur.com/d1hCZLE.png
  - property: og:image
    content: https://i.imgur.com/d1hCZLE.png
date: 2023-11-14
image: https://i.imgur.com/d1hCZLE.png
